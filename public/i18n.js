...
"登录状态已变化，请重试。":"Your sign-in state changed. Please try again.",
  ...
  '答非所问':'Does not answer the question','自相矛盾':'Self-contradiction','补充适用条件':'Adds a condition','提出反例':'Counterexample','质疑数据':'Questions the data','质疑问题前提':'Challenges the premise',
