...
"继续深造，还是尽早进入职场？":"Keep studying, or enter the workplace?","在大城市发展，还是回家乡生活？":"Build a life in a major city, or return home?","更稳定的选择，还是更大的发展空间？":"More stability, or more room to grow?","高薪和成长，哪个更重要？":"Higher pay or growth \u2014 what matters more?","同一个问题，多种视角。选择一个看法，让它换个角度说。":"One question, many perspectives. Choose a voice to explore it.","不替你做决定，只提供多角度的分析。":"Different perspectives. The decision remains yours.","让积累，成为新的视角":"A new perspective on what you save","登录知乎，查看你的收藏、创作与记住的情况。":"Sign in to explore your favorites, writing, and saved context.","检查收藏中的观点与评论区异议。":"Check saved opinions and reader objections.","回看自己的创作与读者反馈。":"Review your writing and reader feedback.","管理你确认过的个人情况与选择。":"Manage your confirmed context and choices.",
  ...
  '先选一种玩法':'Pick a way to play','辩论场：你站一边，知镜站对面。圆桌八方：几位不同立场的角色互相讨论，你在旁边听、随时插话。':'Debate: you take a side and Zhijing takes the other. Round table: personas with different stances discuss while you listen and chime in.',
  '选一方的论点，和知镜正面辩一辩':'Pick a side’s argument and debate Zhijing','挑几位角色上桌，听他们互相讨论':'Seat a few personas and hear them discuss','观点桌面':'Opinion Table','换个玩法':'Switch mode',
  '第 1 步 · 你站哪一方？':'Step 1 · Which side are you on?','选好之后，从这一方的言论里挑一条打出去，知镜站到对面，用原话和评论区的反驳跟你辩。它先承认你站得住的地方，再打你最薄弱的一环，最后追问你一句。不判胜负。':'Then lead with one of that side’s arguments. Zhijing takes the other side and argues with source quotes and comment pushback: first what holds up for you, then your weakest link, then a question back. No winner is declared.',
  '或者用你自己的话：':'Or in your own words:','用这条开辩':'Lead with this',
  '第 1 步 · 挑选上场的角色：点看山请它上桌或下桌（最多 5 位），也可以加一个你自己的角色，然后开始讨论。':'Step 1 · Choose who sits at the table: tap a Kanshan to seat or unseat it (up to 5), or add your own persona, then start.','第 2 步 · 听他们讨论：可以插话，也可以再聊一轮。':'Step 2 · Listen in: chime in or run another round.',
  '问知镜 · 决策顾问':'Ask Zhijing · Decision guide','帮你看清处境：哪边的理由更贴近你':'See which side’s reasons fit your situation','我先问你几个问题，一题一题来；也可以直接打字说你的情况。':'I’ll ask a few questions, one at a time — or just type your situation.',
  '按你现在说的情况，还看不出哪边更贴近你':'Based on what you’ve shared, neither side fits clearly yet','这是说哪边的理由更适用于你，决定还是你来做。':'This shows which side’s reasons apply to you more; the decision is still yours.','哪一边的理由更贴近你':'Which side’s reasons fit you','还看不出哪边更贴近':'No clear fit yet',
  '真实回答和评论，顾问帮你对号入座':'Real answers and comments, with a guide to match them to you','辩论场、圆桌八方':'Debate, round table','回到看两边接着聊':'Back to both sides',
  '论点对照、圆桌八方、辩论场':'Arguments, round table, debate','两边各自在意什么':'What each side cares about','论点来自原话，论据点开能看原文；标了「有人不同意」的，评论区当场有人反驳。':'Arguments come from source quotes; open one to check it. “A reader disagreed” marks direct pushback in the comments.','更看重 / 适合':'Values / fits',
  '观点桌面的两种玩法':'Two ways to use the table','圆桌八方':'Round table','几位角色互相讨论，你在旁边听':'Personas discuss while you listen','辩论场':'Debate arena','你站一边，知镜站对面':'You take a side; Zhijing takes the other',
  '点看山请它上桌或下桌（最多 5 位），也可以加一个你自己的角色；他们会围绕这个问题、拿原话互相讨论。':'Tap a Kanshan to seat or unseat it (up to 5), or add your own persona. They will discuss the question using the source quotes.',
  '他们真正的分歧':'Where they really disagree','角色名，如：我妈':'Name, e.g. My mom','他的立场，如：希望我找个稳定的工作':'Their stance, e.g. wants me to find a stable job','加上桌':'Add to table','自定义角色名':'Custom persona name','自定义角色的立场':'Custom persona stance',
  '再聊一轮':'Another round','清空重来':'Start over','几位正在讨论…（约 10 秒）':'They are discussing… (about 10 seconds)',
  '观点桌面里':'At the opinion table','圆桌八方的分歧':'Where the round table disagreed','辩论场':'Debate arena','你站得住的地方':'Where your case holds','还没回答的追问':'The question still open',
  '先在「看两边」告诉顾问你的情况，讨论会更贴近你':'Tell the guide your situation under “Both sides” to make this more personal',
  '先在「看两边」里跟顾问说说你的情况，让它对照一次原话。这里会整理出：你的情况、哪一边的理由更贴近你、还缺的信息，和可以先做的一步。':'Tell the guide about your situation under “Both sides” first and let it check the quotes once. This page will then collect your situation, which side’s reasons fit you, what is still unclear, and one next step.',
  '知镜适合「A 还是 B」这类要做选择、想听听别人经验的问题；这个问题更像查资料或求方法，评论区很少有人争论。换成二选一的问法试试，比如「考研还是直接工作」。':'Zhijing works best for “A or B” choices where other people’s experience helps. This looks more like a lookup or how-to question, which rarely sparks debate in the comments. Try phrasing it as a choice, e.g. “postgraduate study or start working”.','你插了一句':'You chimed in','插一句，比如：如果我家里能兜底呢？':'Chime in, e.g. what if my family can support me?','插一句':'Chime in','插话':'Chime in','至少请两位角色上桌。':'Seat at least two personas.','自定义角色最多两位。':'Up to two custom personas.',
  '你站哪一边？':'Which side are you on?','选一边，知镜站到另一边，拿原话和评论区的反驳跟你辩。它先承认你站得住的地方，再打你最薄弱的一环，最后追问你一句。不判胜负。':'Pick a side. Zhijing takes the other and argues with source quotes and comment pushback: first what holds up for you, then your weakest link, then a question back. No winner is declared.',
  '换边':'Switch sides','重新选':'Choose again','你':'You','知镜正在找原话反驳你…':'Zhijing is finding quotes to push back…','说出你的论点，比如：大厂的背书以后跳槽更有用':'Make your case, e.g. a big-company name helps later job moves','你的论点':'Your argument','知镜在想…':'Thinking…','反驳它':'Argue back',
  '换个性格':'Personality','换知镜的性格':'Change Zhijing’s personality','跳过':'Skip','这一边没找到理由。':'No supporting reason was found on this side.',
  '先说说你的情况吧：可以直接打字，也可以回答下面几个问题（一题一题来）。想换个性格，就点上面的头像。':'Tell me about your situation — type freely, or answer the questions below one at a time. To change my personality, tap an avatar above.',
  '观点桌面 · 和知镜聊':'Opinion Table · Talk it through','说你的情况、追问、辩一辩':'Share your situation, follow up, debate','和知镜聊聊我的情况':'Talk it through with Zhijing','回到观点桌面接着聊':'Back to the table','辩一辩':'Debate',
  '选一个角度，知镜就用这个语气和你聊；也可以让它当你的反方。':'Pick an angle and Zhijing will talk in that voice — or ask it to argue the other side.',
  '先说说你的情况吧：可以直接打字，也可以点下面更像你的选项。想换个角度，就点桌上的一只看山。':'Tell me about your situation first — type freely or pick an option below. For another angle, pick a Kanshan at the table.',
...
const EN_PATTERNS=[
  ...
  [/^会结合你在看两边说的 (\d+) 条情况$/,m=>`Uses the ${m[1]} details you shared`],
  [/^你站「(.+)」，辩了 (\d+) 轮$/,m=>`You argued for “${translateEnglish(m[1])}” for ${m[2]} rounds`],
  [/^我是知镜，你的决策顾问。你在「(.+)」和「(.+)」之间纠结，我不替你选，但会帮你看清：按你的情况，哪一边的理由更贴近你。$/,m=>`I’m Zhijing, your decision guide. You are weighing “${translateEnglish(m[1])}” against “${translateEnglish(m[2])}”. I won’t choose for you, but I’ll help you see which side’s reasons fit your situation.`],
  [/^按你说的情况，「(.+)」这一边的理由更贴近你$/,m=>`Given your situation, the reasons for “${translateEnglish(m[1])}” fit you more`],
  [/^第 2 步 · 挑一条「(.+)」这边的言论打出去$/,m=>`Step 2 · Lead with an argument for “${translateEnglish(m[1])}”`],
  [/^但也留意另一边：(.+)$/,m=>`But note the other side: ${m[1]}`],
  [/^「(.+)」这一边$/,m=>`The “${translateEnglish(m[1])}” side`],
  [/^开始讨论（(\d+) 位）$/,m=>`Start discussion (${m[1]})`],
  [/^第 (\d+)\/(\d+) 题$/,m=>`Question ${m[1]}/${m[2]}`],
  [/^我站「(.+)」$/,m=>`I’m for “${translateEnglish(m[1])}”`],
  [/^你 · (.+)$/,m=>`You · ${translateEnglish(m[1])}`],
  [/^知镜 · 站「(.+)」$/,m=>`Zhijing · for “${translateEnglish(m[1])}”`],
  [/^知镜 · (.+)$/,m=>`Zhijing · ${translateEnglish(m[1])}`],
  [/^你说得对的地方：(.+)$/,m=>`Where you’re right: ${m[1]}`],
  [/^ 回应 (.+)$/,m=>` replying to ${translateEnglish(m[1])}`],
  [/^请「(.+)」下桌$/,m=>`Remove “${m[1]}” from the table`],
  [/^回观点桌面接着聊（(\d+) 轮）$/,m=>`Back to the table (${m[1]} rounds)`],
  ...
  [/^你问：(.+)$/,m=>`You asked: ${m[1]}`],
  [/^我是知镜。你在「(.+)」和「(.+)」之间纠结，我不替你选，只帮你把知乎上的原话和你自己的情况对上。$/,m=>`I’m Zhijing. You are weighing “${translateEnglish(m[1])}” against “${translateEnglish(m[2])}”. I will not choose for you; I will help connect the source quotes with your own situation.`],
